 ...
 * 이때, 조회된 행들의 집합을 "RESULT SET" (조회 결과 집합) 이라고 한다.
 * 
...
SELECT EMP_ID, EMP_NAME, PHONE FORM EMPLOYEE;
...
SELECT ENO_ID, EMP_NAME, SALARY, PHONE
FROM EMPLOYEE
...
-- NOT BETWEEN A AND B : A 이상 B 이하가 아닌 경우
--                     -> A 미만, B 초과
...
OR DEPT_CODE IS NULL; -- 부서 코드가 없는 2명
