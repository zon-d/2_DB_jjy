...
-- ORA-00001: 무결성 제약 조건(KH_JJY.USER_ID_U)에 위배됩니다
...
-- ORA-00001: 무결성 제약 조건(KH_JJY.USER_ID_NAME_U)에 위배됩니다
...
--> 기본키 중복으로 오류
-- ORA-00001: 무결성 제약 조건(KH_JJY.USER_NO_PK)에 위배됩니다
...
-- ORA-02291: 무결성 제약조건(KH_JJY.GRADE_CODE_FK)이 위배되었습니다- 부모 키가 없습니다
...
WHERE GRADE_CODE = 30;
-- ORA-02292: 무결성 제약조건(KH_JJY.GRADE_CODE_FK)이 위배되었습니다- 자식 레코드가 발견되었습니다
...
-- ORA-02290: 체크 제약조건(KH_JJY.GENDER_CHECK)이 위배되었습니다


-- CHECK 제약 조건은 범위로도 설정 가능. ex) BETWEEN
...
CREATE TABLE USER_TEST(
	...
	USER_ID CHAR(10) CONSTRAINT UK_USER_ID UNIQUE,
	USER_PWD CHAR(20) CONSTRAINT NN_USER_PWD NOT NULL,
	PNO CHAR(14) CONSTRAINT UK_PNO NOT NULL,
	GENDER CHAR(10) CONSTRAINT GENDER_CHECK CHECK( GENDER IN ('남', '여')),
	PHONE CHAR(20),
	ADDRESS CHAR(50),
	STATUS VARCHAR2(3) DEFAULT 'N' CONSTRAINT NN_STATUS NOT NULL, NOT NULL CHECK('Y', 'N')
);
...
ALTER TABLE EMPLOYEE ADD CONSTRAINT SAL_LEBEL
...
ALTER TABLE LOCATION ADD CONSTRAINT NATIONAL_CODE
