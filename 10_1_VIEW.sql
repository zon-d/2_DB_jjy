...
-- VIEW에 포함되지 않은 컬럼(DEPT_TITLE)
-- INSERT 시 NULL이 삽입된. ('D0', NULL, 'L3)

-- 만약 VIEW에 포함되지 않은 컬럼(DEPT_TITLE)에
-- NOT NULL 제약조건이 설정되어 있는 경우
-- 정상적인 INSERT가 진행되지 않는다!
--> ORA-01400: NULL을 ("KH_JJY"."DEPT_COPY2"."DEPT_TITLE") 안에 삽입할 수 없습니다
